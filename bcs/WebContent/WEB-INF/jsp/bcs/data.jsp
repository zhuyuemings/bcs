...
<body>
	...
	<div class="template-page-wrapper">
		<div class="navbar-collapse collapse templatemo-sidebar">
			<ul class="templatemo-sidebar-menu">
				...
				<li class="active"><a href="#"><i class="fa fa-child"></i>实时数据</a></li>
		...
		<div class="templatemo-content-wrapper">
			<div class="templatemo-content">
				<div class="panel panel-default well">
					<div class="panel-heading"><h1>实时数据</h1></div>
					<table class="table">
						<thead>
							<tr>
								<th>记录时间</th>
						...
						<tbody>
							<tr>
								<td id="recordtime"><fmt:formatDate value="${sensorData.recordtime}" pattern="yyyy年MM月dd日 HH时mm分ss秒"/></td>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			window.setInterval(getRealTimeData, 1000); 
		});

		function getRealTimeData() {
			$.post("<c:url value='/web/getRealTimeData'/>", null, function(jsonResult) {
				if (jsonResult != null) {
					$("#recordtime").text(jsonResult.recordtime);
					$("#temperature").text(jsonResult.temperature);
					$("#humidity").text(jsonResult.humidity);
					$("#sound").text(jsonResult.sound);
				}
			}, 'json');
		}
	</script>
